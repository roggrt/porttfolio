                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        >
                            {services.map((service, index) => {
                                ...
                                // Custom WhatsApp messages for each service
                                const whatsappMessages = [
                                    "Hola, me interesa crear una página web corporativa para mi empresa. ¿Me pueden ayudar?",
                                    "Hola, quisiera información sobre el desarrollo de una tienda en línea para mi negocio",
                                    "Hola, necesito desarrollar una aplicación web personalizada. ¿Me pueden asesorar?"
                                ];

                                const encodedMessage = encodeURIComponent(whatsappMessages[index]);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            className="flex items-center justify-center gap-2 w-full bg-accent-red dark:bg-accent-yellow text-white px-4 py-3 rounded-lg font-medium hover:opacity-90 transition-all group mt-auto"
                                        >
                                            <svg
