            ...
            <nav className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="md:hidden flex items-center gap-2">
                        ...
                        {isMobileMenuOpen && (
                            <div className="mobile-menu absolute top-full right-0 mt-2 w-64 bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden max-h-[80vh] overflow-y-auto">
                                <div className="p-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <button
                                            ...
                                            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-accent-red dark:bg-accent-red text-white rounded-lg hover:bg-red-700 transition-colors text-sm"
                                        >
                                            <MessageSquareMore size={16} />
